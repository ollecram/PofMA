...
\author{Walter Rudin}
\title{Principi dell'Analisi Matematica\\
\small{Terza Edizione --- Mc Graw Hill, 1976}}
\maketitle
...
%\include{WRudin_PofMA_P}	% Prefazione  
%\include{WRudin_PofMA_1}	% Numeri Reali e Complessi
%\include{WRudin_PofMA_2}	% Basi di Topologia
%\include{WRudin_PofMA_3}	% Successioni e Serie Numeriche
%\include{WRudin_PofMA_4}	% Continuità
%\include{WRudin_PofMA_5}	% Derivazione
%\include{WRudin_PofMA_6}	% Integrale di Riemann-Stieltjes
%\include{WRudin_PofMA_7}	% Successioni e Serie di Funzioni
%\include{WRudin_PofMA_8}	% Alcune Funzioni Speciali
%\include{WRudin_PofMA_9}	% Funzioni di Più Variabili
%\include{WRudin_PofMA_10}	% Integrazione delle Forme Differenziali
%\include{WRudin_PofMA_11}	% La Teoria di Lebesque
